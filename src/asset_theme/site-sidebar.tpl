<!-- nav-tabs -->
<div class="site-sidebar-tab-content tab-content" style="height:550px;">
      ...
      <div>
        <form class="margin-vertical-20" role="search">
          <div class="input-search input-search-dark">
            ...
            <input type="text" class="form-control" id="inputSearch" name="search" placeholder="Search User ID/Name">
...
<div id="conversation" class="conversation">
  <div class="conversation-header" style="padding:10px;" >
  ...
  <div class="conversation-reply">
      <input class="form-control" style="width:300px;" type="text" placeholder="Say something">
  </div>
</div>